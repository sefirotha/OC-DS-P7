...
output_model_predict = create_model("output_model_predict", prediction=1.0)
output_model_predict_proba = create_model("output_model_predict_proba", prediction_proba=0.68)
...
@app.post("/predict", response_model=output_model_predict)
...
@app.post("/predict_proba", response_model=output_model_predict_proba)
